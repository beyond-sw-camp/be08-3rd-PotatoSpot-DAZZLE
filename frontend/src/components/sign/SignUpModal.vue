            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="text-start" @submit.prevent="handleSubmit">
                        ...
                        <MaterialInput v-model="email" class="input-group-dynamic mb-2" placeholder="이메일"
                            type="email" />
                        <MaterialInput v-model="password" class="input-group-dynamic mb-2" placeholder="비밀번호"
                            type="password" />
                        ...
                        <p class="mt-4 text-sm text-center">
                            ...
                            <a href="#" class="text-info text-gradient font-weight-bold"
                                @click.prevent="openLoginModal">로그인</a>
                        </p>
                    </form>
                </div>
            </div>
